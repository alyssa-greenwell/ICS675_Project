...
Generative AI was used in this project to modify the tree_plotter.py script to use midpoint rooting instead of oupgroup rooting. It was also used to help add multithreading to the alignment_table.py script to reduce the runtime.
